...
<body>
    ...
    <h1 style="margin:0px; padding-top:10px;">　12月度　座席予約状況</h1>
    <table class="reservation">
        ...
        <tr><td class="date">1日</td><td class="date">（金）</td><td>
            <img alt="" class="style1" src="img/false.jpg" /></td><td>
                <img alt="" class="style1" src="img/false.jpg" /></td><td>
            ...
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
                <img alt="" class="style1" src="img/false.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td>
            <td class="g"></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td>
            </tr>
        ...
        <tr><td class="date">4日</td><td class="date">（月）</td><td>
            <img alt="" class="style1" src="img/false.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
                <img alt="" class="style1" src="img/false.jpg" /></td><td class="g"></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
                <img alt="" class="style1" src="img/false.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td>
            <td class="g"></td>
        ...
        <tr><td class="date">5日</td><td class="date">（火）</td><td>
            ...
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
                <img alt="" class="style1" src="img/false.jpg" /></td>
            <td class="g"></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td><td>
            <input type="image" onclick="showDetailsView(event);return false;" src="./img/true.jpg" /></td>
            </tr>
