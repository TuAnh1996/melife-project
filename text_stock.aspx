<%@ Page Language="C#" AutoEventWireup="true" CodeFile="text_stock.aspx.cs" Inherits="_Default" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:DropDownList ID="DropDownList2" runat="server">
                        <asp:ListItem Value="天王寺教室"></asp:ListItem>
                        <asp:ListItem Value="本町教室"></asp:ListItem>
                        <asp:ListItem Value="浜松教室"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;
...
&nbsp;<asp:Button ID="Button9" runat="server" Text="テキスト検索" />
                ...
                <td class="end">
                    <input id="Button10" type="button" value="検索" /></td>
            </tr>
            </table>
            <hr />
