...
<body>
    ...
    <div id="dbase">
        ...
        <table class="add_payment">
            <tr><td class="l_h_h" colspan="1">名前(性)</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td colspan="1">
                <asp:TextBox ID="TextBox11" runat="server" Width="98%"></asp:TextBox>
                </td><td class="l_h_h">名前(名)</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td>
                <asp:TextBox ID="TextBox12" runat="server" Width="98%"></asp:TextBox>
                </td></tr>
            <tr><td class="l_h_h" colspan="1">区分</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td>
                <td colspan="4">
                <asp:RadioButton ID="RadioButton6" runat="server" Text="社員" />
                <asp:RadioButton ID="RadioButton7" runat="server" Text="非常勤" />
                </td></tr>
                </table>
                <div class="button_area">
        <asp:Button ID="Button12" runat="server" Text="登録" />
            &nbsp;<asp:Button ID="Button15" runat="server" Text="クリア" />
            &nbsp;<asp:Button ID="Button16" runat="server" Text="戻る" />
            </div>
                <br />
    </div>
