...
<body>
    ...
    <div id="dbase">
        ...
        <table class="add_payment">
            <tr><td class="l_h" colspan="1">名前(性)</td><td colspan="1">
                <asp:TextBox ID="TextBox11" runat="server" Width="98%">MECKT-EM001</asp:TextBox>
                </td><td class="l_h">名前(名)</td><td>
                <asp:TextBox ID="TextBox12" runat="server" Width="98%">山田　隆</asp:TextBox>
                </td></tr>
            <tr><td class="l_h" colspan="1">区分</td><td colspan="3">
                <asp:RadioButton ID="RadioButton6" runat="server" Text="社員" Checked="True" />
                <asp:RadioButton ID="RadioButton7" runat="server" Text="非常勤" />
                </td></tr>
                </table>
        <br />
        <asp:Button ID="Button2" runat="server" Text="この担当者を削除する" />
                <div class="button_area">
        <asp:Button ID="Button12" runat="server" Text="変更" />
            &nbsp;<asp:Button ID="Button13" runat="server" Text="クリア" />
