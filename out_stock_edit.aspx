<%@ Page Language="C#" AutoEventWireup="true" CodeFile="out_stock_edit.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div id="dbase">
        ...
        <tr><td class="l">受講生ID</td><td class="r">
            <asp:TextBox ID="TextBox8" runat="server" Width="30%">00275</asp:TextBox>
            <asp:Button ID="Button9" runat="server" Text="検索" />
&nbsp;<asp:Button ID="Button10" runat="server" Text="受講生検索" />
            </td></tr>
        <tr><td class="l">受講生名</td><td class="r">
            - 佐藤 紀子　様</td></tr>
        <tr><td class="l">テキストID</td><td class="r">
            ...
            <tr><td class="l">テキスト名</td><td class="r">
                - パソコン入門 1単元</td></tr>
            <tr><td class="l">出庫日</td><td class="r">
            <asp:TextBox ID="TextBox10" runat="server" Width="30%">2010/09/25</asp:TextBox>
            </td></tr>
        <tr><td class="l">テキスト購入のみ</td><td class="r">
