<%@ Page Language="C#" AutoEventWireup="true" CodeFile="out_stock.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div id="dbase">
        ...
        <tr><td class="l">受講生ID</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
            <asp:TextBox ID="TextBox8" runat="server" Width="30%"></asp:TextBox>
            <asp:Button ID="Button9" runat="server" Text="検索" />
&nbsp;<asp:Button ID="Button10" runat="server" Text="受講生検索" />
            </td></tr>
        <tr><td class="l">受講生名</td><td class="h_h_h">&nbsp;</td><td class="r">
            -
            ここに受講生の名前が表示されます</td></tr>
        <tr><td class="l">テキストID</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
            ...
            <tr><td class="l">テキスト名</td><td class="h_h_h">&nbsp;</td><td class="r">
                -
            ここにテキストの名前が表示されます</td></tr>
            <tr><td class="l">出庫日</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
            <asp:TextBox ID="TextBox10" runat="server" Width="30%"></asp:TextBox>
            </td></tr>
        <tr><td class="l">テキスト購入のみ</td><td class="h_h_h">&nbsp;</td><td class="r">
            <asp:CheckBox ID="CheckBox2" runat="server" Text="現在の受講講座を変更しない" />
            </td></tr>
