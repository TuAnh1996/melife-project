    ...
    <div id="dbase">
            ...
            <asp:Panel ID="pContents" runat="server" Width="320px" 
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="100%">
                        <asp:ListItem Value="はじめてのパソコン入門"></asp:ListItem>
                    </asp:DropDownList>
                    <br />
                    <br />
                    講座を選択：<br /> 
                    <asp:DropDownList ID="DropDownList2" runat="server" Width="100%">
                        <asp:ListItem Value="Windows 7編"></asp:ListItem>
                    </asp:DropDownList>
                    <br />
        ...
        <tr><td class="l">テキストID</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
            ...
            <tr><td class="l">入庫日</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
            <asp:TextBox ID="TextBox10" runat="server" Width="30%"></asp:TextBox>
            </td></tr>
        <tr><td class="l">入庫数</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r">
