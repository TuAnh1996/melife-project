    ...
    <div id="dbase">
        ...
        <table class="add_payment">
            <tr>
                ...
                </td><td class="l_h_h">祝日の名称</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r_h">
