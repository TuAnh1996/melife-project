...
<body>
    ...
    <div id="dbase">
        ...
        <tr><td class="l_h">講座ID</td><td class="r_h">
            <asp:TextBox ID="TextBox5" runat="server" Width="98%">C2201</asp:TextBox>
            </td><td class="l_h">表示名</td><td class="r_h">
            <asp:TextBox ID="TextBox11" runat="server" Width="98%">パソコン入門　Windows XP編</asp:TextBox>
                </td></tr>
                        
        </table>
                <br />
                    <asp:Button ID="Button14" runat="server" Text="この講座を削除する" />
                <div class="button_area">
                    <asp:Button ID="Button2" runat="server" Text="登録" />
                &nbsp;<asp:Button ID="Button12" runat="server" Text="クリア" />
                &nbsp;<asp:Button ID="Button13" runat="server" Text="戻る" />
                </div>
        </div>
    </div>
