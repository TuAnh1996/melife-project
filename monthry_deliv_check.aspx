...
<body>
    ...
    <div id="dbase">
        ...
        <h2>月初テキスト発注納品チェック</h2>
        <h1>検索</h1>
            <table id="search">
                <tr>
                    <td>
        カテゴリの選択：<asp:DropDownList ID="DropDownList2" runat="server">
                <asp:ListItem Value="全て"></asp:ListItem>
...
<table class="sim" style="width:100%; font-size:10px;">
                ...
                <td>
                    ...
                    冊</td>
                <td>
                    <asp:TextBox ID="TextBox15" runat="server" Width="40px"></asp:TextBox>
                    冊</td>
                </tr>
            </table>
            
            <div class="button_area">&nbsp;<asp:Button ID="Button18" runat="server" Text="登録" />
                    &nbsp;<asp:Button ID="Button16" runat="server" Text="クリア" />&nbsp;<asp:Button 
                ID="Button17" runat="server" Text="戻る" /></div>
        </div>
        <asp:Button ID="Button6" runat="server" Text="チェックリスト印刷" />
