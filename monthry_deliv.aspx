    ...
    <div id="dbase">
        ...
        カテゴリの選択：<asp:DropDownList ID="DropDownList2" runat="server">
                <asp:ListItem Value="パソコン入門"></asp:ListItem>
                    ...
                    <td class="end">
                        <input id="Button19" type="button" value="検索" /></td>
                </tr>
            </table>
        <hr />
        <h1>発注数の変更</h1>
<table class="sim" style="width:100%; font-size:12px;">
                ...
                <td>
                    ...
                    冊</td>
                <td>
                    &nbsp;<asp:TextBox ID="TextBox18" runat="server" Width="40px"></asp:TextBox>
                    &nbsp;冊</td>
                <td>
                ...
                <td>
                    ...
                    冊</td>
                <td>
                    <asp:TextBox ID="TextBox19" runat="server" Width="40px"></asp:TextBox>
                    &nbsp;冊</td>
                <td>
                ...
                <td>
                    ...
                    冊</td>
                <td>
                    <asp:TextBox ID="TextBox20" runat="server" Width="40px"></asp:TextBox>
                    &nbsp;冊</td>
                <td>
                    <asp:TextBox ID="TextBox17" runat="server" Width="40px"></asp:TextBox>
                    冊</td>
                </tr>
            </table>
        
            <div class="button_area">&nbsp;<asp:Button ID="Button18" runat="server" Text="変更" />
                    &nbsp;<asp:Button ID="Button16" runat="server" Text="クリア" />&nbsp;<asp:Button 
                ID="Button17" runat="server" Text="戻る" /></div>
