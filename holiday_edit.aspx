...
<body>
    ...
    <div id="dbase">
        ...
        <table class="add_payment">
            <tr>
                <td class="l_h">日付</td><td class="r_h">
                <asp:TextBox ID="TextBox13" runat="server">2010/12/23</asp:TextBox>
                </td><td class="l_h">祝日の名称</td><td class="r_h">
                <asp:TextBox ID="TextBox14" runat="server">天皇誕生日</asp:TextBox>
                </td>
            </tr>
                </table>
            <br />
        <asp:Button ID="Button3" runat="server" Text="この祝日を削除する" />
                <div class="button_area"><asp:Button ID="Button2" runat="server" Text="登録" />&nbsp;<asp:Button 
                        ID="Button15" runat="server" Text="クリア" />&nbsp;<asp:Button ID="Button16" 
