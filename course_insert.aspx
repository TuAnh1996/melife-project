...
<body>
    ...
    <div id="dbase">
        ...
        <tr><td class="l_h_h">講座ID</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r_h">
            <asp:TextBox ID="TextBox5" runat="server" Width="98%"></asp:TextBox>
            </td><td class="l_h_h">新規講座名</td><td class="h_h"><p style="text-align:center; background-color:White; color:Red;margin:0;padding:0;font-size:8px;border:1px solid Red">必須</p></td><td class="r_h">
