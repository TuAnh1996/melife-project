...
<body>
    ...
    <div id="dbase">
        ...
        <table class="add_payment">
            <tr>
                <td class="l_h">受信日</td><td class="r_h">
            <asp:TextBox ID="TextBox14" runat="server" Width="99%">2010/10/07</asp:TextBox>
            </td>
            <td class="l_h">問い合わせ手段</td><td class="r_h">
                                <asp:RadioButton ID="RadioButton7" runat="server" Text="電話" />
                                <asp:RadioButton ID="RadioButton6" runat="server" Text="直来" />
            </td>
                            </tr>
        <tr><td class="l_h">ふりがな(性)</td><td class="r_h">
            <asp:TextBox ID="TextBox9" runat="server" Width="99%">いわさき</asp:TextBox>
            </td>
            <td class="l_h">ふりがな(名)</td><td class="r_h">
            <asp:TextBox ID="TextBox10" runat="server" Width="99%">よしのり</asp:TextBox>
            </td>
        </tr>
        ...
        <td class="l_h">性別</td>
        <td class="r_h">
            <asp:RadioButton ID="RadioButton4" runat="server" Text="男性" Checked="True" />
            <asp:RadioButton ID="RadioButton5" runat="server" Text="女性" />
                                </td>
        </tr>
                            <tr>
                                <td class="l_h">希望講座</td><td class="r_h" colspan="3">
            ...
            <tr>
                <td class="l_h">媒体</td><td class="r_h" colspan="3">
                ...
                　その他の場合：<asp:TextBox ID="TextBox19" runat="server" Width="200px"></asp:TextBox>
                            ...
                            <tr>
                                <td class="l_h">経験</td><td class="r_h">
                                <asp:RadioButton ID="RadioButton10" runat="server" Text="あり" Checked="True" />
                                <asp:RadioButton ID="RadioButton11" runat="server" Text="なし" />
                </td><td class="l_h">説明会希望日</td><td class="r_h">
                                日付：<asp:TextBox ID="TextBox17" runat="server" Width="30%"></asp:TextBox>
                                　時間：<asp:DropDownList ID="DropDownList13" runat="server">
                    <asp:ListItem Value="13:00～"></asp:ListItem>
                </asp:DropDownList>
                </td>
                        </tr>
        <tr><td class="l_h">担当</td><td class="r" colspan="3">
